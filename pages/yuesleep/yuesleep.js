...
Page({
  ...
  after:function(){//后一周
    ...
    this.setData({
      date:this.data.date+24*60*60*1000*31
    })  
    this.af_be();
  },
  before:function(){//前一周
  ...
  get:function(time){
    app.request('POST', '/sleep_day/', time, res => {
      ...
      if (res.data.code == 200) {
        ...
        let data1=[2, 5, 4.3, 4.6, 4.7, 5.2, 4.4, 5, , 4.6,4, 5, 4.3, 4.6, 4.7, 5.2, 4.4, 5, 4.3, 4.6,4, 5, 4.3, 4.6, 4.7, 5.2, 4.4, 5, 4.3, 4.6];
        let data2=[2, 7, 6.3, 6.4, 6.2, 7, 6.8, 6.2, , 6.8,6, 7, 6.3, 6.4, 6.2, 7, 6.8, 6.2, 7, 6.8,6, 7, 6.3, 6.4, 6.2, 7, 6.8, 6.2, 7, 6.8];
  ...
  init_one1: function (data1,data3,data4) {           //饼图
    this.oneComponent1.init((canvas, width, height,dpr) => {
        ...
        setOption1(chart,data1,data3,data4)
        this.chart = chart;
        return chart;
    });
  },
